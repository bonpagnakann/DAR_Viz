def calculate_exemp_size(dataset, new_class, person):
    ...
    holdout_sizes = {
        ...
        'MS': {
            ('3', '2'): {'0': [100, 197, 390, 770, 120], '1': [100, 195, 379, 737, 120],
                         '2': [100, 191, 366, 699, 120]},
            ('22', '21', '31'): {'0': [100, 197, 390, 770, 180], '1': [100, 195, 379, 737, 180],
                                 '2': [100, 191, 366, 699, 180]},
        ...
        'RW': {
            ...
            ('22', '32'): {'0': [100, 303, 921, 2795, 180], '1': [100, 300, 898, 2692, 180],
                           '2': [100, 299, 894, 2674, 180]},
            ('211', '222'): {'0': [100, 303, 921, 2795, 240], '1': [100, 300, 898, 2692, 240],
                             '2': [100, 299, 894, 2674, 240]},
            ('1111', '2111', '3111'): {'0': [100, 303, 921, 2795, 300], '1': [100, 300, 898, 2692],
                                       '2': [100, 299, 894, 2674, 300]},
        },
        'PM': {
            ...
            ('321', '341'): {'0': [100, 240, 575, 1378], '1': [100, 237, 562, 1332, 240],
                             '2': [100, 235, 554, 1303, 240]},
