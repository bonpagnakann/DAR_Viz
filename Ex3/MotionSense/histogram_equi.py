...
def process_task_file(input_file, output_file):
    ...
    for method in methods:
        ...
        if method in ['FeTrIL', 'DDGR', 'VAE - Adapt', 'VAE - BBox', 'TaskVAE', 'DAR']:  # For VAE-based methods, use only the method name
...
def plot_boxplot(input_csv, output_image, task_name, method_order, exemplar_size_order, acc_type):
    ...
    for method in method_order:
        if method in ['FeTrIL', 'DDGR', 'VAE - Adapt', 'VAE - BBox', 'TaskVAE', 'DAR']:  # VAE-based methods have no exemplar size
