...
def new_old_class_acc(dataset, scenario, params=None):
    ...
    for person in people:
        ...
        folder_file = [
                       ('FeTrIL', person + '_ce_fetril_10.txt'),
                       ('DDGR', person + '_ce_ddgr_10.txt'),
...
def all_class_acc(dataset, scenario, params=None):
    ...
    for person in people:
        ...
        folder_file = [('FeTrIL', person + '_ce_fetril_10.txt'),
                       ('DDGR', person + '_ce_ddgr_10.txt'),
                       ('VAE_Adapt', person + '_ce_vae_adaptive_boundary_none_10.txt'),
                       ('VAE_BBox', person + '_ce_vae_boundary_box_none_10.txt'),
                       ('VAE_Filter', person + '_ce_vae_boundary_box_probability_10.txt'),
