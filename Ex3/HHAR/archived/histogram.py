...
def plot_boxplot(input_csv, output_image, task_name, method_order, exemplar_size_order, acc_type):
    ...
    for method in method_order:
        if method.startswith("VAE") or method == 'FeTrIL' or method == 'DDGR':  # VAE-based methods have no exemplar size
    ...
    sns.boxplot(data=melted_data, x="Method", y="Accuracy", palette="Set3")
...
def accuracy_histogram(dataset, scenario):
    ...
    for p in person:
        for acc in acc_list:
            ...
            method_order = [
                "FeTrIL", "DDGR", "VAE - Adapt", "VAE - BBox", "VAE - Filter", "VAE - GMM"
            ]
